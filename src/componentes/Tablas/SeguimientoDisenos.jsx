...
export default function SeguimientoDisenos() {
              ...
              <div className="tabla-card border-0 shadow-lg rounded-4 overflow-hidden">
                <div className="card-header bg-white py-4 px-4 px-md-5 border-bottom-0">
                  <div className="d-flex justify-content-between align-items-center mb-4">
                    <div>
                      <h3 className="fw-bold text-dark mb-1">Seguimiento de diseñadores</h3>
                      <p className="text-muted mb-0">Seguimiento de los diseñadores, los clientes asignados y sus diseños.</p>
                    </div>
                  </div>
                              ...
                              <td className="pe-5 text-end">
                                <button
                                  className="btn btn-sm btn-outline-primary fw-bold"
                                    ...
                                    title="Ver todos los clientes asignados a este diseñador"
                                >
                                  <i className="fa fa-eye me-1"></i> Ver Clientes
                                </button>
                              </td>
                            </tr>
                          ))
